...
{
    CFileName lFileName(imageanalyzer::core::CPathName(L"path1\\path2"), L"name.txt");
    lFileName.SetSeparator(L"\\");
    ASSERT_STREQ(lFileName.GetFullFileName().c_str(), L"path1\\path2\\name.txt");
}
...
{
    CFileName lFileName(imageanalyzer::core::CPathName(L"path0/path1\\path2"), L"name.txt");
    lFileName.SetSeparator(L"/");
...
{
    CFileName lFileName(imageanalyzer::core::CPathName(L"path1\\path2\\"), L"/filename.exe");
    lFileName.SetSeparator(L"\\");
...
TEST_F(CFileName_test, AddPath1)
{
    CFileName lFileName(imageanalyzer::core::CPathName(L"path1\\path2"), L"filename.exe");
    lFileName.SetSeparator(L"\\");
    lFileName.AddPath(imageanalyzer::core::CPathName(L"path3"));
...
TEST_F(CFileName_test, AddFileName1)
{
    CFileName lFileName(L"path1\\path2\\");
    lFileName.SetSeparator(L"\\");
    lFileName.AddFileName(CFileName(imageanalyzer::core::CPathName(L"\\/\\path3\\/\\"), L""));
    ASSERT_STREQ(lFileName.GetFullFileName().c_str(), L"path1\\path2\\path3\\");
}
...
TEST_F(CFileName_test, AddFileName2)
{
    ...
    lFileName.SetSeparator(L"\\");
    lFileName.AddFileName(CFileName(imageanalyzer::core::CPathName(L"\\/\\path3\\/\\"), L"new_test.c"));
    ASSERT_STREQ(lFileName.GetFullFileName().c_str(), L"path1\\path2\\path3\\new_test.c");
}
